...
```{r pitch speed (all pitch types) vs. heat index}
...
complete_db %>% 
  ...
  geom_smooth() +
    labs(
    title = "Pitch Speed (All Pitches) vs. Heat Index",
    x = "Pitch Start Speed (MPH)",
    y = "Heat Index (ºC)"
  )
# again, looks like no association. maybe it dips slightly at the highest heat index, like above 35? However when categorizing (e.g. looking at pitch speeds at heat indexes only above 35) there was still no association 
