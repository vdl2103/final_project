...
tr9 = pitch_tidy_db %>% 
  ...
  labs(
    title = "Fastball Pitch Speed and Max Temperature", subtitle = "Texas Rangers",
    x = "Max Temperature (C)",
    y = "Pitch Starting Speed (MPH)"
  ) +
...
```{r heat index distributions, warning=FALSE}
...
Exploratory analyses examining pitch speed (of all pitches) vs. heat index indicated that pitch start speed may slightly decrease at extreme heat indexes (e.g. over 35 ºC), particularly for four-seam fastballs in the Southwest and West. 

```{r pitch speed (all types) vs. heat index, warning=FALSE}
