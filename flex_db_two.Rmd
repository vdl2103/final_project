...
```{r load data, message=FALSE, warning=FALSE, include = FALSE, echo = FALSE, eval = FALSE}
...
```{r fig.5, message=FALSE, warning=FALSE, eval = FALSE}
...
```{r fig.6, message=FALSE, warning=FALSE, eval = FALSE}
