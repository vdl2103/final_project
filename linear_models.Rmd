...
pitch_tidy_db <- read.csv("./data/pitch_tidy_db.csv") %>%
  select(des, id, type, start_speed, end_speed, pitch_type, inning_side, inning, count, away, home, pitcher, event, batter_name, pitcher_name, team_name, tmax, tmin, tmean, tdmean, heat_index, rh) %>% 
...
```
A one inning increase is associated with a 0.197 mph increase in the start speed of four-seam fastballs (p < 0.001).
